...
import { accordion, accordionItem, accordionTitle, alignWide, anchor, anchorList, bubbleQuestion, bubbles, item, keyFigure, modal, navigation, plus, postList, postListAlt, shape, shapes, tabs, title } from './index';
...
ReactDOM.createRoot( document.getElementById( 'root' ) ).render(
	<React.StrictMode>
		<div className="grid grid-cols-6 container mx-auto gap-6">
			...
			<IconItem name="Accordion Item" icon={ accordionItem } size={ 64 } />
			<IconItem name="Accordion Title" icon={ accordionTitle } size={ 64 } />
			...
			<IconItem name="Modal" icon={ modal } size={ 64 } />
